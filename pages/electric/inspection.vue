	...
	<view class="main main-top-bg">
		...
		<view class="content" v-show="kapCur==0">
			<view class="flex  p-xs flex-table  mb-sm">
				<view class="flex-sub table-title-bg padding-sm">检修区域</view>
				<view class="flex-sub table-title-bg padding-sm">工作认领</view>
				<view class="flex-sub table-title-bg padding-sm">巡检任务</view>
				<view class="flex-sub table-title-bg padding-sm">未完成</view>
				<view class="flex-sub table-title-bg padding-sm">状态</view>
				<view class="flex-sub table-title-bg padding-sm">操作</view>
			</view>
			<view class="flex  p-xs flex-table mb-sm">
				...
				<view class="flex-sub table-content-bg padding-sm" @click="goInspection">操作</view>
			</view>
			<view class="flex  p-xs flex-table mb-sm">
				<view class="flex-sub table-content-bg padding-sm">检修区域</view>
				<view class="flex-sub table-content-bg padding-sm">工作认领</view>
