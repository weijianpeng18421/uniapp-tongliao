...
/***/ 0:
/*!****************************************************!*\
  !*** E:/MUIProject/uni-HDxinjiang/nuiapps/main.js ***!
  \****************************************************/
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./store/index.js */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var basics = function basics() {__webpack_require__.e(/*! require.ensure | pages/basics/home */ "pages/basics/home").then((function () {return resolve(__webpack_require__(/*! ./pages/basics/home.vue */ 917));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};


_vue.default.component('basics', basics);var components = function components() {__webpack_require__.e(/*! require.ensure | pages/component/home */ "pages/component/home").then((function () {return resolve(__webpack_require__(/*! ./pages/component/home.vue */ 924));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};


_vue.default.component('components', components);var plugin = function plugin() {__webpack_require__.e(/*! require.ensure | pages/plugin/home */ "pages/plugin/home").then((function () {return resolve(__webpack_require__(/*! ./pages/plugin/home.vue */ 931));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};


_vue.default.component('plugin', plugin);var cuCustom = function cuCustom() {__webpack_require__.e(/*! require.ensure | colorui/components/cu-custom */ "colorui/components/cu-custom").then((function () {return resolve(__webpack_require__(/*! ./colorui/components/cu-custom.vue */ 938));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
...
/***/ 10:
/*!*****************************************************************************!*\
  !*** E:/MUIProject/uni-HDxinjiang/nuiapps/App.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************/
/*! no static exports found */
...
/***/ 11:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/MUIProject/uni-HDxinjiang/nuiapps/App.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _auth = __webpack_require__(/*! ./util/auth */ 31);
var _commonConstant = _interopRequireDefault(__webpack_require__(/*! ./constant/commonConstant */ 32));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =

{
  ...
  onShow: function onShow() {
    var _this = this;
    var templateType = (0, _auth.getByKey)(_commonConstant.default.PATROL_TEMPLATE_TYPE);
    // 1、判断缓存中有没有templateType数据，没有就请求，如果请求不到跳转错误页面，
    // 2、进行缓存，如果无法链接网络，那么跳转至作错误页面
    if (templateType == null || templateType == '') {
      var patrol = _store.default.getters.patrolTemplateType;
      if (patrol == undefined || patrol.length == 0) {
        _this.$store.dispatch('GetPatrolTemplateType').then(function (res) {
        ...
        console.debug(_store.default.getters.patrolTemplateType);
      }
      // 缓存中有分类信息，但vuex中没有
    } else if (_store.default.getters.patrolTemplateType.length == 0) {
      _this.$store.dispatch('setPatrolTemplateTypeFromCache', templateType);
    }

    // 2、检查缓存中是否有模板信息内容
    var patrolTemplate = (0, _auth.getByKey)(_commonConstant.default.PATROL_TEMPLATE);
    if (patrolTemplate.length == 0) {
      _this.$store.dispatch('GetPatrolTemplate').then(function (res) {
      }).catch(function (error) {
        uni.navigateTo({
      ...
      // 向vuex中设置内容
    } else if (_store.default.getters.patrolTemplate.length == 0) {
      _this.$store.dispatch('setPatrolTemplateFromCache', patrolTemplate);
    }
    // 判断用户是否登录了
    var token = (0, _auth.getByKey)(_commonConstant.default.ACCESS_TOKEN_NAME);
    if (token == null || token === '') {
      uni.redirectTo({
    ...
    //判断审核人信息
    var checkUser = (0, _auth.getByKey)('submitUser');
...
/***/ 36:
/*!*************************************************************************************!*\
  !*** E:/MUIProject/uni-HDxinjiang/nuiapps/App.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 37:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/MUIProject/uni-HDxinjiang/nuiapps/App.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 9:
/*!****************************************************!*\
  !*** E:/MUIProject/uni-HDxinjiang/nuiapps/App.vue ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
component.options.__file = "E:/MUIProject/uni-HDxinjiang/nuiapps/App.vue"
